...
<img alt="Profile" class="w-24 h-24 md:w-32 md:h-32 rounded-full border-4 border-white shadow-md" src="https://randomuser.me/api/portraits/men/32.jpg"/>
...
<a class="text-blue-600 hover:text-blue-800" href="#"><i class="fab fa-twitter"></i></a>
<a class="text-blue-600 hover:text-blue-800" href="#"><i class="fab fa-github"></i></a>
<a class="text-blue-600 hover:text-blue-800" href="#"><i class="fab fa-linkedin"></i></a>
<a class="text-blue-600 hover:text-blue-800" href="#"><i class="fas fa-globe"></i></a>
</div>
</div>
...
<a class="py-4 px-1 tab-active" href="#">Posts</a>
<a class="py-4 px-1 text-gray-600 hover:text-blue-600 transition" href="#">Comments</a>
<a class="py-4 px-1 text-gray-600 hover:text-blue-600 transition" href="#">Bookmarks</a>
<a class="py-4 px-1 text-gray-600 hover:text-blue-600 transition" href="#">Stats</a>
<a class="py-4 px-1 text-gray-600 hover:text-blue-600 transition" href="#">Settings</a>
</nav>
</div>
</div>
...
<a class="text-blue-600 hover:text-blue-800 text-sm font-medium" href="#">View Article</a>
</div>
</div>
<!-- Article 2 -->
<div class="border-b border-gray-200 pb-6 mb-6">
...
<p class="text-sm text-gray-600 mb-1">On <a class="text-blue-600 hover:underline" href="#">The Future of Web Development</a></p>
<p class="text-gray-700 mb-2">"Great article! WebAssembly is really changing the game."</p>
<p class="text-xs text-gray-500">2 days ago</p>
</div>
<div class="border-b border-gray-200 pb-4">
<p class="text-sm text-gray-600 mb-1">On <a class="text-blue-600 hover:underline" href="#">React 18 Features</a></p>
<p class="text-gray-700 mb-2">"The new concurrent rendering is a game changer for our app."</p>
<p class="text-xs text-gray-500">1 week ago</p>
</div>
<div>
<p class="text-sm text-gray-600 mb-1">On <a class="text-blue-600 hover:underline" href="#">TypeScript 5.0</a></p>
...
<a class="mt-4 inline-block text-blue-600 hover:text-blue-800 text-sm font-medium" href="#">
...
<div class="space-y-3">
<a class="block p-3 hover:bg-gray-50 rounded-md transition" href="#">
