        ...
        <nav class="flex-1 space-y-1">
            ...
            <div class="sidebar-dropdown">
                ...
                <div class="sidebar-dropdown-menu hidden pl-2 mt-1 space-y-1">
                    ...
                    <a href="{{ route('posts.index') }}" class="flex items-center px-3 py-2 text-sm rounded-md text-gray-300 hover:bg-gray-700 hover:text-white pl-11">
                        <i class="fas fa-folder mr-3 text-xs"></i>
                        <span>All Posts</span>
                    </a>
                    <a href="{{ url('/blog') }}" class="flex items-center px-3 py-2 text-sm rounded-md text-gray-300 hover:bg-gray-700 hover:text-white pl-11">
