...
<input class="px-4 py-3 rounded-md text-gray-800 w-full sm:w-96" placeholder="Search articles..." type="text"/>
...
<img alt="Web Development" class="w-full h-48 object-cover" src="https://placehold.co/480x200/png"/>
<div class="p-6">
...
<!-- Featured Post 2 -->
<div class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition">
<img alt="Artificial Intelligence" class="w-full h-48 object-cover" src="https://placehold.co/480x200/png"/>
<div class="p-6">
<div class="flex items-center text-sm text-gray-500 mb-2">
...
<!-- Featured Post 3 -->
<div class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition">
<img alt="Cloud Computing" class="w-full h-48 object-cover" src="https://placehold.co/480x200/png"/>
<div class="p-6">
<div class="flex items-center text-sm text-gray-500 mb-2">
...
<!-- Recent Post 2 -->
<article class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition flex flex-col md:flex-row">
<img alt="Cybersecurity" class="md:w-1/3 h-48 md:h-auto object-cover" src="https://placehold.co/480x200/png"/>
<div class="p-6 md:w-2/3">
<div class="flex items-center text-sm text-gray-500 mb-2">
...
<!-- Recent Post 3 -->
<article class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition flex flex-col md:flex-row">
<img alt="Low-Code Development" class="md:w-1/3 h-48 md:h-auto object-cover" src="https://placehold.co/480x200/png"/>
<div class="p-6 md:w-2/3">
<div class="flex items-center text-sm text-gray-500 mb-2">
